...
<div style="background: #EEE8AA">
    <div class="layui-container" >
        <div class="layui-row">
            <br>
            <%--首部面包屑--%>
            <span class="layui-breadcrumb" style="display: none" lay-separator=">" >
              <a><cite>当前位置</cite></a>
...
<script>
    ...
    layui.use(['element', 'jquery', 'layer'], function(){
        ...
        //导航条
        $("#myTab li:nth-child(2)").prop("class","layui-nav-item layui-this");
        ...
        $('a[page]').click(function () {
            ...
            //提交超链接
            window.open('${context}/main/showAllMedicinalDiet/'+inputWords+'/'+pageNum, '_self');
        })
        //退出
        $(".tips").click(function () {
            layer.open({
